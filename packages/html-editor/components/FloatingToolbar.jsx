import { faBold, faCode, faItalic, faStrikethrough, faSubscript, faSuperscript, faUnderline, } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { Floater, isMarkActive, Toolbar, ToolbarItem } from '@pompom/core';
import { toggleMark } from 'prosemirror-commands';
import React from 'react';
export const FloatingToolbar = ({ schema, }) => {
    return (<Floater>
      <Toolbar>
...
//# sourceMappingURL=FloatingToolbar.jsx.map